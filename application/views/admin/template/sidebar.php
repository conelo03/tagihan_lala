        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <a class="dropdown-item has-icon text-danger" data-confirm="Logout|Anda yakin ingin keluar?" data-confirm-yes="document.location.href='<?= base_url('logout-admin'); ?>';"><i class="fas fa-sign-out-alt"></i> Logout</a>
            </div>
          </li>
        </ul>
      </nav>
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="<?= $title == 'Dashboard' ? 'active' : ''; ?>"><a class="nav-link" href="<?= base_url('dashboard-admin');?>"><i class="fas fa-circle"></i> <span>Dashboard</span></a></li>  
            ...
            <li class="<?= $title == 'Kelola Tarif' ? 'active' : ''; ?>"><a class="nav-link" href="<?= base_url('tarif');?>"><i class="fas fa-circle"></i> <span>Kelola Tarif</span></a></li>
            ...
            <li class="<?= $title == 'Laporan Tagihan' ? 'active' : ''; ?>"><a class="nav-link" href="<?= base_url('laporan-tagihan');?>"><i class="fas fa-circle"></i> <span>Laporan Tagihan</span></a></li> 
          ...
          <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
            <button class="btn btn-danger btn-lg btn-block btn-icon-split" data-confirm="Logout|Anda yakin ingin keluar?" data-confirm-yes="document.location.href='<?= base_url('logout-admin'); ?>';"><i class="fa fa-sign-out-alt"></i> Logout</button>
          </div>
        </aside>
      </div>
