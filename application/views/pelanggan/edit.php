              ...
              <div class="card-header">
               ...
               <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" name="id_pel" class="form-control" value="<?= set_value('id_pel', $pelanggan['id_pel']); ?>" required="">
                  <?= form_error('id_pel', '<span class="text-danger small">', '</span>'); ?>
                </div>
                <div class="form-group">
                  <label>No. KTP</label>
                  <input type="text" name="no_ktp" class="form-control" value="<?= set_value('no_ktp', $pelanggan['no_ktp']); ?>" required="">
                ...
                <div class="form-group">
                  <label>Email</label>
                  <input type="text" name="email" class="form-control" value="<?= set_value('email', $pelanggan['email']); ?>" required="">
